...
async function handleBadwordDetection(sock, chatId, message, userMessage, senderId) {
    ...
    const badWords = [
        ...
        'hash', 'trip', 'rolling', 'BINGWA', 'bingwa', 'data deals', 'DATA DEALS',
        ...
        '250mbs@20( 24hrs)',
        '1gb@99 (24hrs)',
        'nb = above data unabuy once a day',
        'the only package unaeza buy more times a day.',
        '2gb @110sh valid 24hrs',
        '1gb @ 23sh. valid 1hr',
        '1.5gb @ 52sh  valid  3hrs',
        'minutes offers',
        '45mins @22sh (3hr)',
        '50mins @sh51(till midnight)',
        'the mbs will be loaded to the number used in making payment.',
        'notice minutes will now be purchased via our till number:4096814',
        'minutes with or without okoa',
        '22 bob 45 mins 3hrs',
        '51 bob 50 minutes till midnight',
        'payment :till number:4096814',
        'working hours 24/7',
        'till number 4096814',
        'incase of delay reverse call #0743658569'
    ];
